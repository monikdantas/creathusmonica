...
<html lang="en">
  <head>
    ...
    <link href="<?php echo base_url('assets/css/sidebars.css') ?>" rel="stylesheet">
...
<main class="d-flex flex-nowrap">
  ...
  <div class="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark" style="width: 15%;">
    ...
    <span class="fs-4">Creathus</span>
    </a>
    <hr>
    <ul class="nav sticky-top nav-pills flex-column mb-auto">
      <li class="nav-item">
 ...
 <!-- FIM Sidebar -->
  <div class="b-example-divider b-example-vr" style="width: 0.4%;"></div>

  


<div class="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark" style="width: 84%;" >  
