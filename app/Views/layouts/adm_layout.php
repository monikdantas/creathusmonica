    ...
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      <div class="position-sticky pt-3">
        <ul class="nav flex-column">
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="<?php echo site_url('usuario/inicio_adm') ?>">
              <span data-feather="home" class="align-text-bottom"></span>
              Início
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="<?php echo site_url('filme/index') ?>">
              <span data-feather="film" class="align-text-bottom"></span>
              Filmes
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="<?php echo site_url('usuario/index') ?>">
